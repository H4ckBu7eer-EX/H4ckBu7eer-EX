...
<body>
<div class="header">
    <h1 class="tit" style="text-shadow: 0 0 20px #fff;">H4ckBu7eer</h1>
    <img src="logo.png" class="logo" alt="">
</div>
<div class="intro">
    <p style="font-family: 方正仿宋简体;font-size: 20px";text-shadow: 0 0 10px yellow;>我们是一群热爱技术的网络安全爱好者，致力于网络安全和技术研究。组织成立于2022年,现有7名核心成员。</p>
</div>
<div class="members">
    <div class="member">
        <h3>LFZX</h3>
...
<p style="font-family: 方正仿宋简体;font-size: 19px;text-align: center;text-shadow: 0 0 20px #94F877;">排名不分前后，能力不分强弱，技术不容出错</p>
</body>
